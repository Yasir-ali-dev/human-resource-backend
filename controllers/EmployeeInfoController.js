...
const createEmployeeInfo = async (req, res) => {
  ...
  if (
    ...
    throw new BadRequestError(
      "employee_id, employeeType, employeeGrade, department_name, workCalender, hired_date, username, email, name, role,status, report_to, shift, martial_status and gender are required fields !"
    );
  }
